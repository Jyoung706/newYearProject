...
router.get('/wish-count', wishController.wishCountController);
router.get('/wish-check', asyncWrap(wishController.wishDuplicationCheck));
router.post('/analyze', asyncWrap(keywordController.keywordAnalyze));
